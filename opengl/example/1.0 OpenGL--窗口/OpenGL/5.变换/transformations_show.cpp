//
//  transformations_show.cpp
//  OpenGL
//
//  Created by xiaerfei on 2022/8/15.
...
int transformations_show() {
    ...
    shader ourShader("transformations_show_vertex.vs", "transformations_show_fragment.fs");
    float vertices[] = {
